...
export const UsersIcon: React.FC<{ className?: string }> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.5-2.962a3.75 3.75 0 015.25 0m-5.25 0a3.75 3.75 0 00-5.25 0m3.75 7.162c-3.146 0-6-1.683-6-3.75S3.146 9 6 9s6 1.683 6 3.75-2.854 3.75-6 3.75z" />
  </svg>
);
...
export const DesktopComputerIcon: React.FC<{ className?: string }> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
...
export const PresentationChartBarIcon: React.FC<{ className?: string }> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M3.375 19.5h17.25m-17.25 0a1.125 1.125 0 01-1.125-1.125V6.375m1.125 13.125A1.125 1.125 0 004.5 18.375h15.75m-15.75 0v-1.5c0-.621.504-1.125 1.125-1.125h13.5c.621 0 1.125.504 1.125 1.125v1.5m-15.75 0h15.75M4.5 4.5v.75A.75.75 0 013.75 6h-.75a.75.75 0 01-.75-.75V4.5m3 0v.75A.75.75 0 015.25 6h-.75a.75.75 0 01-.75-.75V4.5m3 0v.75a.75.75 0 01-.75.75h-.75a.75.75 0 01-.75-.75V4.5m3 0v.75a.75.75 0 01-.75.75h-.75a.75.75 0 01-.75-.75V4.5m3 0v.75a.75.75 0 01-.75.75h-.75a.75.75 0 01-.75-.75V4.5m3 0v.75a.75.75 0 01-.75.75h-.75a.75.75 0 01-.75-.75V4.5m3 0v.75a.75.75 0 01-.75.75h-.75a.75.75 0 01-.75-.75V4.5m0 10.5h.008v.008h-.008V15zm.75 0a.75.75 0 00-.75.75v.008c0 .414.336.75.75.75h.008a.75.75 0 00.75-.75v-.008a.75.75 0 00-.75-.75h-.008zm-3.75 0h.008v.008h-.008V15zm.75 0a.75.75 0 00-.75.75v.008c0 .414.336.75.75.75h.008a.75.75 0 00.75-.75v-.008a.75.75 0 00-.75-.75h-.008zm-3.75 0h.008v.008h-.008V15zm.75 0a.75.75 0 00-.75.75v.008c0 .414.336.75.75.75h.008a.75.75 0 00.75-.75v-.008a.75.75 0 00-.75-.75h-.008z" />
    </svg>
);
...
export const HomeIcon: React.FC<{ className?: string }> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 12l8.954-8.955a.75.75 0 011.06 0l8.955 8.955a.75.75 0 01-1.06 1.06l-1.72-1.72V19.5a.75.75 0 01-.75.75h-5.25a.75.75 0 01-.75-.75v-6.75a.75.75 0 00-.75-.75h-1.5a.75.75 0 00-.75.75V19.5a.75.75 0 01-.75.75h-5.25a.75.75 0 01-.75-.75v-8.185l-1.72 1.72a.75.75 0 01-1.06-1.06z" />
  </svg>
);

export const BanIcon: React.FC<{ className?: string }> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
...
export const ExclamationIcon: React.FC<{ className?: string }> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126zM12 15.75h.007v.008H12v-.008z" />
    </svg>
);
...
export const ThumbUpIcon: React.FC<{ className?: string }> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
...
export const ThumbDownIcon: React.FC<{ className?: string }> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M6.633 10.5c.806 0 1.533-.446 2.031-1.08a9.041 9.041 0 012.861-2.4c.723-.384 1.35-.956 1.653-1.715a4.498 4.498 0 00.322-1.672V3a.75.75 0 01.75-.75A2.25 2.25 0 0116.5 4.5c0 1.152-.26 2.243-.723 3.218-.266.558.107 1.282.725 1.282h3.126c1.026 0 1.945.694 2.054 1.715.045.422.068.85.068 1.285a11.95 11.95 0 01-2.649 7.521c-.388.482-.987.729-1.605.729H13.48c-.483 0-.964-.078-1.423-.23l-3.114-1.04a4.501 4.501 0 00-1.423-.23H5.904M6.633 10.5l-1.84-1.84a.75.75 0 00-1.06 0l-1.06 1.06a.75.75 0 000 1.06l1.84 1.84a.75.75 0 001.06 0l1.06-1.06a.75.75 0 000-1.06z" />
    </svg>
);
...
export const AdjustmentsHorizontalIcon: React.FC<{ className?: string }> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
...
export const AcademicCapIcon: React.FC<{ className?: string }> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path d="M3.375 19.5h17.25m-17.25 0a1.125 1.125 0 01-1.125-1.125M3.375 19.5h1.5v.005h-1.5V19.5zm1.5.005v.005h1.5V19.5h-1.5zm1.5-.005h1.5v.005h-1.5V19.5zm1.5.005v.005h1.5V19.5h-1.5zm1.5-.005h1.5v.005h-1.5V19.5zm1.5.005v.005h1.5V19.5h-1.5zm1.5-.005h1.5v.005h-1.5V19.5zm1.5.005v.005h1.5V19.5h-1.5zm1.5-.005h1.5v.005h-1.5V19.5zM4.5 19.5v-2.25a3.375 3.375 0 00-3.375-3.375H.75V19.5h3.75zM21 17.25v2.25h-3.75v-2.25a3.375 3.375 0 00-3.375-3.375h-1.5a3.375 3.375 0 00-3.375 3.375V19.5h-1.5v-2.25a3.375 3.375 0 00-3.375-3.375H4.5v-2.25a3.375 3.375 0 013.375-3.375h8.25a3.375 3.375 0 013.375 3.375v2.25z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 6.375a3.375 3.375 0 00-6.75 0" />
...
export const DotsVerticalIcon: React.FC<{ className?: string }> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
